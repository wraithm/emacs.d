;; Packages
(require 'package)
(require 'tls) ; temporary hack while waiting for emacs 26.3
(setq gnutls-algorithm-priority "NORMAL:-VERS-TLS1.3") ; temporary hack while waiting for emacs 26.3
 ...
 '(safe-local-variable-values
   (quote
    ((intero-targets "bitnomial-exchange:test:bitnomial-exchange-test")
     (intero-targets "bitnomial-core:test:bitnomial-core-test")))))
